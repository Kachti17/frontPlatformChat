                                    ...
                                    <div class="row align-items-center ">
                                       <div class="col-sm-7 col-md-6 col-8">
                                          <div class="quantity buttons_added">
                                                ...
                                                <input type="number" step="1" min="1" max="" name="quantity" value="1" title="Qty" class="input-text qty text ms-1" size="4" pattern="" inputmode=""><input type="button" value="+" class="plus h5"> -->
                                                <groupbtn/>
                                          </div>
                                       </div>
                  ...
                  <div class="card-body">
                     <div class="checkout-product">
                        <div class="row align-items-center">
                           <div class="col-sm-2">
                              <span class="checkout-product-img">
                              <a href="#"><img class="img-fluid rounded" src="@/assets/images/store/02.jpg" alt=""></a>
                              </span>
                           </div>
                           <div class="col-sm-4">
                              <div class="checkout-product-details">
                  ...
                  <div class="card-body">
                     <div class="checkout-product">
                        <div class="row align-items-center">
                           <div class="col-sm-2">
                              <span class="checkout-product-img">
                              <a href="#"><img class="img-fluid rounded" src="@/assets/images/store/03.jpg" alt=""></a>
                              </span>
                           </div>
                           <div class="col-sm-4">
                              <div class="checkout-product-details">
                  ...
                  <div class="card-body">
                     <div class="checkout-product">
                        <div class="row align-items-center">
                           <div class="col-sm-2">
                              <span class="checkout-product-img">
                              <a href="#"><img class="img-fluid rounded" src="@/assets/images/store/04.jpg" alt=""></a>
                              </span>
                           </div>
                           <div class="col-sm-4">
                              <div class="checkout-product-details">
            ...
            <div class="col-lg-4">
               <div class="card">
                  <div class="card-body">
                     ...
                     <router-link :to="{name:'store.store-checkoutaddress'}" href="#" class="btn btn-primary d-block mt-3 next">Place order</router-link>
                  </div>
               </div>
               <div class="card">
