   ...
   <div class="row">
               ...
               <div class="row align-items-center">
                  <div class="col-lg-6">
                     <div class="image-block mt-3">
                        <img src="@/assets/images/blog/b1.jpg" class="img-fluid rounded w-100" alt="blog-img"  loading="lazy">
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="blog-description shadow-none p-3 text-center">
                        ...
                        <div class="group-smile mt-4 d-flex flex-wrap align-items-center justify-content-between position-right-side">
                           <div class="iq-media-group">
                              ...
                              <img class="img-fluid rounded-circle" src="@/assets/images/icon/01.png" alt=""  loading="lazy">
                              </a>
                              <a href="#" class="iq-media">
                              <img class="img-fluid rounded-circle" src="@/assets/images/icon/02.png" alt=""  loading="lazy">
                              </a>
                              <a href="#" class="iq-media">
                              <img class="img-fluid rounded-circle" src="@/assets/images/icon/03.png" alt=""  loading="lazy">
                              </a>
                              <a href="#" class="iq-media">
                              <img class="img-fluid rounded-circle" src="@/assets/images/icon/07.png" alt=""  loading="lazy">
                              </a>
                           </div>
      ...
      <div class="col-lg-6">
         <div class="card card-transparent card-block card-stretch card-height blog-grid blog-single">
            <div class="card-body p-0 position-relative">
               <div class="image-block">
                  <img src="@/assets/images/blog/04.jpg" class="img-fluid rounded w-100" alt="blog-img"  loading="lazy">
               </div>
               <div class="blog-description p-3">
                  <div class="date"><a href="#" tabindex="-1">3 Month ago</a></div>
                  <h5 class="mb-2">Containing coronavirus spread comes</h5>
         ...
         <div class="card card-block card-stretch card-height shadow-none blog-grid">
            <div class="card-body p-0">
               <div class="row align-items-center">
                  <div class="col-lg-6">
                     <div class="image-block mt-3">
                        <img src="@/assets/images/blog/b3.jpg" class="img-fluid rounded w-100" alt="blog-img"  loading="lazy"> 
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="blog-description shadow-none p-3 text-center">
      ...
      <div class="col-lg-6">
         <div class="card card-transparent card-block card-stretch card-height blog-grid blog-single">
            <div class="card-body p-0 position-relative">
               <div class="image-block">
                  <img src="@/assets/images/blog/03.jpg" class="img-fluid rounded w-100" alt="blog-img"  loading="lazy">
               </div>
               <div class="blog-description p-3">
                  <div class="date"><a href="#" tabindex="-1">3 Month ago</a></div>
                  <h5 class="mb-2">Containing coronavirus spread comes</h5>
         ...
         <div class="card card-block card-stretch card-height shadow-none blog-grid">
            <div class="card-body p-0">
               <div class="row align-items-center">
                  ...
                  <div class="col-lg-6">
                     <div class="image-block mt-3">
                        <img src="@/assets/images/blog/b4.jpg" class="img-fluid rounded w-100" alt="blog-img" loading="lazy">
                     </div>
                  </div>
               </div>
            </div>
