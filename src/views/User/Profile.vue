          ...
          <div class="profile-header">
            <div class="cover-container">
              <b-img
                ...
                class="w-100"
              />
              <ul class="header-nav d-flex flex-wrap justify-end p-0 m-0"></ul>
            </div>
                  ...
                  <div class="user-post-data p-3">
                    <div class="d-flex flex-wrap">
                      ...
                      <div class="media-support-info mt-2">
                        <h5 class="mb-0">
                          <b-link href="#" class="">Anna Sthesia</b-link>
                        </h5>
                    ...
                    <div class="d-flex flex-wrap">
                      <div class="media-support-user-img mr-3">
                        <b-img
                          rounded="circle"
                          fluid
                          :src="require('../../assets/images/user/user-2.jpg')"
                          alt=""
                        />
                      </div>
                      <div class="media-support-info mt-2">
                        <h5 class="mb-0">
                          <b-link href="#" class="">jenny issad</b-link>
                        </h5>
                        <p class="mb-0 text-primary">colleages</p>
                      </div>
                      <div
                  ...
                  <div class="comment-area p-3">
                    ...
                    >
                      <div class="d-flex align-items-center">
                        ...
                        >
                          <b-link id="clickme" href="javascript:void(0);"
                            ><i class="ri-heart-line"></i
                          ></b-link>
                          <span class="ml-1">140</span>
                        </div>
                  ...
                  <div class="user-detail text-center">
                    ...
                    <div class="profile-detail mt-3">
                      ...
                      <p class="mb-0">
                        ...
                        industry's standard dummy text ever since the 500s
                      </p>
                    </div>
                  </div>
                </template>
    ...
    return {
      ...
      friends: [
        ...
        },
        {
          ...
          image: require("../../assets/images/user/user-6.jpg"),
        },
        {
          name: "Pete Sariya",
          role: "Web Designer",
