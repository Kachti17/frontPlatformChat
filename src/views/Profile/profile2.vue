            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2 grid-cols-3">
                            <img src="@/assets/images/user/18.jpg" class="img-fluid bg-soft-info rounded img-size" alt="profile-image">
                            <img src="@/assets/images/user/15.jpg" class="img-fluid bg-soft-primary rounded img-size" alt="profile-image">
                            <img src="@/assets/images/user/17.jpg" class="img-fluid bg-soft-info rounded img-size" alt="profile-image">
                            <img src="@/assets/images/user/13.jpg" class="img-fluid bg-soft-primary rounded img-size" alt="profile-image">
                            <img src="@/assets/images/user/14.jpg" class="img-fluid bg-soft-warning rounded img-size" alt="profile-image">
                            <img src="@/assets/images/user/10.jpg" class="img-fluid bg-soft-primary rounded img-size" alt="profile-image">
                            <img src="@/assets/images/user/05.jpg" class="img-fluid bg-soft-danger rounded img-size" alt="profile-image">
                            <img src="@/assets/images/user/19.jpg" class="img-fluid bg-soft-primary rounded img-size" alt="profile-image">
                            <img src="@/assets/images/user/16.jpg" class="img-fluid bg-soft-success rounded img-size" alt="profile-image">
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a class="ratio ">
                            <iframe class="rounded embed-responsive-item" src="https://www.youtube.com/embed/zpOULjyy-n8?rel=0" allowfullscreen></iframe>
                        </a>
                        <a class="ratio">
                            <iframe class="rounded embed-responsive-item" src="https://www.youtube.com/embed/zpOULjyy-n8?rel=0" allowfullscreen></iframe>
                        </a>
                ...
                <div class="card-body" data-toggle="modal" data-target="#post-modal">
                    <ul class="post-comments p-0 m-0">
                        <li class="">
                            <div class="d-flex justify-content-between">
                                <div class="user-img">
                                    <img src="@/assets/images/user/1.jpg" alt="userimg" class="avatar-60 me-3 rounded-circle img-fluid">
                                </div>
                                <div class="w-100">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="w-100">
                                    ...
                                    <hr>
                                        ...
                                        <div class="">
                                            <svg fill="none" width="18px" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                                        </div>
                                        <div class="">
                                            <svg fill="none" width="18px" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 19a2 2 0 01-2-2V7a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1M5 19h14a2 2 0 002-2v-5a2 2 0 00-2-2H9a2 2 0 00-2 2v5a2 2 0 01-2 2z"></path></svg>
                                        </div>
                ...
                <div class="card-body">
                    <ul class="post-comments p-0 m-0">
                        <li class="mb-2">
                            <div class="d-flex justify-content-between">
                                <div class="user-img">
                                    <img src="@/assets/images/user/02.jpg" alt="userimg" class="avatar-60 me-3 rounded-circle img-fluid">
                                </div>
                                <div class="w-100 text-margin">
                                    <h4>Mathilda Gvarliana</h4>
                                    <h5 class="mb-0">March 14, 23:00</h5>
                                    ...
                                    share
                                                    ...
                                                    <span class="card-text-1">Share</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                    <span class="card-text-1 me-1">5.2k people love it</span>
                                                        <a href="#" class="iq-media ">
                                                        <img class="img-fluid item-img rounded-circle card-text-1" src="@/assets/images/user/05.jpg" alt="">
                                                        </a>
                                                        <a href="#" class="iq-media ">
                                                        <img class="img-fluid item-img rounded-circle card-text-1" src="@/assets/images/user/06.jpg" alt="">
                                                        </a>
                                                        <a href="#" class="iq-media ">
                                                        <img class="img-fluid item-img rounded-circle card-text-1" src="@/assets/images/user/07.jpg" alt="">
                                                        </a>
                                                        <a href="#" class="iq-media ">
                                                        <img class="img-fluid item-img rounded-circle card-text-1" src="@/assets/images/user/08.jpg" alt="">
                                                        </a>
                                            </div>
                                    </div>
                                    <form class="d-flex align-items-center mt-3" action="javascript:void(0);">
            ...
            <div class="card-body">
               <ul class="post-comments p-0 m-0">
                  <li class="mb-2">
                     <div class="d-flex justify-content-between">
                        <div class="user-img">
                           <img src="@/assets/images/user/02.jpg" alt="userimg" class="avatar-60 me-3 rounded-circle img-fluid" loading="lazy">
                        </div>
                        <div class="w-100 text-margin">
                                    ...
                                    <div class="w-100 text-margin">
                                       ...
                                       <ul class="post-comments p-0 mt-4">
                                          <li class="mb-2">
                                             <div class="d-flex justify-content-between">
                                                <div class="user-img">
                                                   <img src="@/assets/images/user/02.jpg" alt="userimg" class="avatar-60 me-3 rounded-circle img-fluid avatar-1" loading="lazy">
                                                </div>
                                                <div class="w-100 text-margin">
                                                   <div class="">
                                                      <h5 class="mb-0 d-inline-block me-1">Emma Labelle</h5>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="w-100 text-margin">
                                    ...
                                    <div class="d-grid gap-2 grid-cols-2 mb-2">
                                        <a>
                                            <img src="@/assets/images/user/18.jpg" class="img-fluid bg-soft-info rounded sub-image image-size" alt="profile-image">
                                        </a>
                                        <a>
                                            <img src="@/assets/images/user/17.jpg" class="img-fluid bg-soft-primary rounded sub-image image-size" alt="profile-image">
                                        </a>
                                        <a>
                                            <img src="@/assets/images/user/07.jpg" class="img-fluid bg-soft-info rounded sub-image image-size" alt="profile-image">
                                        </a>
                                        <a>
                                            <img src="@/assets/images/user/09.jpg" class="img-fluid bg-soft-primary rounded sub-image image-size" alt="profile-image">
                                        </a>
                                    </div>
