      ...
      <div class="col-md-8 col-lg-8">
                  ...
                  <div class="tab-pane fade show active" id="Listview" role="tabpanel">
                     <div class="">
                        ...
                        <div class="card-body p-0 pt-3">
                           <ul class="request-list list-inline m-0 p-0">
                                <li class="d-flex align-items-center  justify-content-between flex-wrap" v-for="(sweet,index) in SweetAlert" :key="index">
                                    <div class="user-img img-fluid flex-shrink-0">
                                    <img :src="sweet.img" alt="story-img" class="rounded-circle avatar-40">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                    <h6>{{sweet.name}}</h6>
                                    ...
                                    <a href="#" class="btn btn-secondary rounded" data-extra-toggle="delete" data-closest-elem=".item" @click="deleterequest">Delete Request</a>
                                    </div>
                                </li>
         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="user-post mt-2">
                  <a href="#"><img src="@/assets/images/page-img/p1.jpg" alt="post-image" class="img-fluid w-100" loading="lazy"></a>
               </div>
            </div>
         </div>
      </div>
